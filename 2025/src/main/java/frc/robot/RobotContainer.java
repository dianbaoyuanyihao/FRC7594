...
import frc.robot.Command.Elevator.ElevatorSetpoint;
...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.b().onTrue(new ElevatorSetpoint(elevator, ScoreAngle.L1));
        joystick.a().onTrue(new ElevatorSetpoint(elevator, ScoreAngle.L2));
        joystick.x().onTrue(new ElevatorSetpoint(elevator, ScoreAngle.L3));
        joystick.y().onTrue(new ElevatorSetpoint(elevator, ScoreAngle.L4));
    
        joystick.b().onFalse(new ElevatorSetpoint(elevator, ScoreAngle.DEFAULT));
        joystick.a().onFalse(new ElevatorSetpoint(elevator, ScoreAngle.DEFAULT));
        joystick.x().onFalse(new ElevatorSetpoint(elevator, ScoreAngle.DEFAULT));
        joystick.y().onFalse(new ElevatorSetpoint(elevator, ScoreAngle.DEFAULT));
